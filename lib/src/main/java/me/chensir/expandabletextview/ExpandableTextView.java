...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private static final int DEFAULT_CONTENT_TEXT_SIZE = 15;// unit sp
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int default_text_size_px = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, DEFAULT_CONTENT_TEXT_SIZE, getResources().getDisplayMetrics());
        mContentTextSize = typedArray.getDimensionPixelSize(R.styleable.ExpandableTextView_contentTextSize, default_text_size_px);
        ...
        mContentString = typedArray.getString(R.styleable.ExpandableTextView_contentText);
